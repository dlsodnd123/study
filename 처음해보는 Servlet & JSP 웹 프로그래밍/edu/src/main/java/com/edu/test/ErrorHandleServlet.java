...
public class ErrorHandleServlet extends HttpServlet{
	...
	private static final long serialVersionUID = 879412235384519008L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Integer code = (Integer) req.getAttribute("java.servlet.error.status_code");
		String message = (String) req.getAttribute("javax.servlet.error.message");
		Object type = req.getAttribute("javax.servlet.error.excption_type");
